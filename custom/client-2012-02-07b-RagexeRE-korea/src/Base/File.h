...
public:
	bool Open(const char* fName, unsigned int nOpenFlags, bool bMakeDataPath, bool bReadFolderOnly);
	...
	static bool IsFileExist(const char* fName, bool bReadFolderOnly);
