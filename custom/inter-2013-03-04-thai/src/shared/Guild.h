...
public:
	...
	void GetGuildMemberOnlineList(std::list<std::pair<unsigned long,unsigned long>>& out_listAID);
	...
	void GetGuildPosID(char* Buf, const int ); //TODO
	...
	void GetGuildBanishInfo(char* Buf, const int ); //TODO
	void GetGuildAllyInfo(char* Buf, const int ); //TODO
	void GetGuildMPosition(char* Buf, const int ); //TODO
...
protected:
	...
	/* this+3504 */ std::vector<GUILDALLYINFO*> m_guildAllyInfo;
	/* this+3528 */ std::vector<GUILDBANISHINFO*> m_guildBanishInfo;
	/* this+3552 */ std::vector<GUILDMPOSITION*> m_guildMPosition;
	/* this+3576 */ CMemoryMgr2<GUILDMINFO> m_GuildMInfoMPool;
	/* this+3612 */ CMemoryMgr2<GUILDALLYINFO> m_GuildAllyInfoMPool;
	/* this+3648 */ CMemoryMgr2<GUILDBANISHINFO> m_GuildBanishInfoMPool;
	/* this+3684 */ CMemoryMgr2<GUILDMPOSITION> m_GuildMPositionMPool;

	void SetMoney(int Money);
	int AddMoney(int Money);

	/* this+3720 */ int m_skillDataLength;
	/* this+3724 */ int m_skillPoint;
	/* this+3728 */ BYTE m_skillData[300];
};
