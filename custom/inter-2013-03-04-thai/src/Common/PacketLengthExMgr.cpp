...
std::pair<CPacketLengthExMgr::enumFixedPacketRet,int> CPacketLengthExMgr::IsFixedPacket(const int in_Header) const
{
	...
	if( iter == m_LengthMap.end() )
		return std::pair<enumFixedPacketRet,int>(CPacketLengthExMgr::UNKNOWN, 4);

	if( iter->second.m_Len == -1 )
		return std::pair<enumFixedPacketRet,int>(CPacketLengthExMgr::VARIABLE, iter->second.m_Min);
	else
	if( iter->second.m_Len >= 0 )
		return std::pair<enumFixedPacketRet,int>(CPacketLengthExMgr::FIXED, iter->second.m_Len);
	else
	{
		return std::pair<enumFixedPacketRet,int>(CPacketLengthExMgr::UNKNOWN, 4);
	}
...
void CPacketLengthExMgr::InitPacketLen()
{
	...
	this->CPacketLengthExMgr::Add(10704, 104, 104, 0);
	...
	this->CPacketLengthExMgr::Add(10856, 81, 81, 0);
	this->CPacketLengthExMgr::Add(10857, 81, 81, 0);
	this->CPacketLengthExMgr::Add(10858, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10859, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10860, 43, 43, 0);
	this->CPacketLengthExMgr::Add(10861, 43, 43, 0);
	this->CPacketLengthExMgr::Add(10862, 40, 40, 0);
	this->CPacketLengthExMgr::Add(10863, 40, 40, 0);
	this->CPacketLengthExMgr::Add(10864, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10865, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10866, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10867, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10868, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10869, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10878, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10878, 10, 10, 0);
	...
	this->CPacketLengthExMgr::Add(10909, 22, 22, 0);
