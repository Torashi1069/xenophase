...
std::pair<CPacketLengthExMgr::enumFixedPacketRet,int> CPacketLengthExMgr::IsFixedPacket(const int in_Header) const
{
	...
	if( iter == m_LengthMap.end() )
		return std::pair<CPacketLengthExMgr::enumFixedPacketRet,int>(CPacketLengthExMgr::UNKNOWN, 4);

	if( iter->second.m_Len == -1 )
		return std::pair<CPacketLengthExMgr::enumFixedPacketRet,int>(CPacketLengthExMgr::VARIABLE, iter->second.m_Min);
	else
	if( iter->second.m_Len >= 0 )
		return std::pair<CPacketLengthExMgr::enumFixedPacketRet,int>(CPacketLengthExMgr::FIXED, iter->second.m_Len);
	else
	{
		return std::pair<CPacketLengthExMgr::enumFixedPacketRet,int>(CPacketLengthExMgr::UNKNOWN, 4);
	}
...
{
	m_LengthMap.insert(std::pair<const int,CData>(in_Header, CData(in_Length, in_MinLength, in_ReplayFactor)));
}


void CPacketLengthExMgr::InitPacketLen()
{
	this->CPacketLengthExMgr::Add(10500, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10501, 23, 23, 0);
	this->CPacketLengthExMgr::Add(10733, 39, 39, 0);
	this->CPacketLengthExMgr::Add(10732, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10502, 98, 98, 0);
	this->CPacketLengthExMgr::Add(10503, 98, 98, 0);
	this->CPacketLengthExMgr::Add(10505, 42, 42, 0);
	this->CPacketLengthExMgr::Add(10506, 42, 42, 0);
	this->CPacketLengthExMgr::Add(10678, 151, 151, 0);
	this->CPacketLengthExMgr::Add(10682, 204, 204, 0);
	this->CPacketLengthExMgr::Add(10726, 20, 20, 0);
	this->CPacketLengthExMgr::Add(10504, 19, 19, 0);
	this->CPacketLengthExMgr::Add(10507, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10508, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10509, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10510, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10612, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10611, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10677, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10679, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10680, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10681, 10, 10, 0);
	this->CPacketLengthExMgr::Add(143, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10513, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10000, -1, 71, 0);
	this->CPacketLengthExMgr::Add(10515, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10516, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10517, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10009, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10546, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10019, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10017, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10514, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10511, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10512, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10020, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10518, 86, 86, 0);
	this->CPacketLengthExMgr::Add(10519, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10520, -1, 80, 0);
	this->CPacketLengthExMgr::Add(10521, -1, 60, 0);
	this->CPacketLengthExMgr::Add(10522, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10523, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10524, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10525, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10526, -1, 4, 0);
	this->CPacketLengthExMgr::Add(10527, -1, 4, 0);
	this->CPacketLengthExMgr::Add(10528, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10638, 36, 36, 0);
	this->CPacketLengthExMgr::Add(10529, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10530, -1, 36, 0);
	this->CPacketLengthExMgr::Add(10531, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10532, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10533, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10534, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10545, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10643, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10535, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10536, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10537, 79, 79, 0);
	this->CPacketLengthExMgr::Add(10639, 81, 81, 0);
	this->CPacketLengthExMgr::Add(10538, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10539, 22, 22, 0);
	this->CPacketLengthExMgr::Add(10540, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10541, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10542, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10543, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10544, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10547, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10548, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10549, 22, 22, 0);
	this->CPacketLengthExMgr::Add(11000, 50, 50, 0);
	this->CPacketLengthExMgr::Add(11001, 10, 10, 0);
	this->CPacketLengthExMgr::Add(11002, -1, 8, 0);
	this->CPacketLengthExMgr::Add(11003, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10673, 6, 6, 0);
	this->CPacketLengthExMgr::Add(11009, 6, 6, 0);
	this->CPacketLengthExMgr::Add(11011, 6, 6, 0);
	this->CPacketLengthExMgr::Add(11013, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10550, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10552, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10553, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10554, -1, 20, 0);
	this->CPacketLengthExMgr::Add(10555, -1, 20, 0);
	this->CPacketLengthExMgr::Add(10556, -1, 20, 0);
	this->CPacketLengthExMgr::Add(10557, -1, 20, 0);
	this->CPacketLengthExMgr::Add(10558, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10559, -1, 14, 0);
	this->CPacketLengthExMgr::Add(10560, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10561, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10562, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10563, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10564, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10565, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10566, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10567, 78, 78, 0);
	this->CPacketLengthExMgr::Add(10568, 82, 82, 0);
	this->CPacketLengthExMgr::Add(10569, 102, 102, 0);
	this->CPacketLengthExMgr::Add(10570, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10571, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10572, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10573, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10574, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10575, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10576, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10551, 86, 86, 0);
	this->CPacketLengthExMgr::Add(10577, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10579, 66, 66, 0);
	this->CPacketLengthExMgr::Add(10580, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10578, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10581, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10582, 222, 222, 0);
	this->CPacketLengthExMgr::Add(10583, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10584, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10585, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10586, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10587, -1, 1010, 0);
	this->CPacketLengthExMgr::Add(10588, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10589, 52, 52, 0);
	this->CPacketLengthExMgr::Add(10590, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10591, 186, 186, 0);
	this->CPacketLengthExMgr::Add(10592, 186, 186, 0);
	this->CPacketLengthExMgr::Add(10593, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10594, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10595, 47, 47, 0);
	this->CPacketLengthExMgr::Add(10596, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10597, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10598, 47, 47, 0);
	this->CPacketLengthExMgr::Add(10599, 146, 146, 0);
	this->CPacketLengthExMgr::Add(10601, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10600, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10602, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10603, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10604, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10605, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10606, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10607, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10608, 150, 150, 0);
	this->CPacketLengthExMgr::Add(10609, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10610, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10613, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10614, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10615, 36, 36, 0);
	this->CPacketLengthExMgr::Add(10617, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10616, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10618, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10619, 26, 26, 0);
	this->CPacketLengthExMgr::Add(10637, 26, 26, 0);
	this->CPacketLengthExMgr::Add(10641, 26, 26, 0);
	this->CPacketLengthExMgr::Add(10642, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10670, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10620, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10621, 82, 82, 0);
	this->CPacketLengthExMgr::Add(10622, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10623, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10624, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10625, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10626, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10627, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10628, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10629, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10632, 42, 42, 0);
	this->CPacketLengthExMgr::Add(10640, 46, 46, 0);
	this->CPacketLengthExMgr::Add(10633, 62, 62, 0);
	this->CPacketLengthExMgr::Add(10634, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10635, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10636, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10630, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10631, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10647, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10648, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10649, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10650, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10651, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10652, 40, 40, 0);
	this->CPacketLengthExMgr::Add(10653, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10654, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10655, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10657, 324, 324, 0);
	this->CPacketLengthExMgr::Add(10658, 36, 36, 0);
	this->CPacketLengthExMgr::Add(529, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10659, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10660, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10661, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10662, -1, 125, 0);
	this->CPacketLengthExMgr::Add(10663, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10664, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10665, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10666, 79, 79, 0);
	this->CPacketLengthExMgr::Add(10667, -1, 125, 0);
	this->CPacketLengthExMgr::Add(10668, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10669, 74, 74, 0);
	this->CPacketLengthExMgr::Add(10671, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10672, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10674, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10675, 46, 46, 0);
	this->CPacketLengthExMgr::Add(10676, 85, 85, 0);
	this->CPacketLengthExMgr::Add(10683, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10684, 136, 136, 0);
	this->CPacketLengthExMgr::Add(10698, 75, 75, 0);
	this->CPacketLengthExMgr::Add(10705, 73, 73, 0);
	this->CPacketLengthExMgr::Add(10706, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10707, 79, 79, 0);
	this->CPacketLengthExMgr::Add(10708, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10709, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10710, 107, 107, 0);
	this->CPacketLengthExMgr::Add(10711, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10712, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10713, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10686, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10687, 27, 27, 0);
	this->CPacketLengthExMgr::Add(10691, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10692, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10693, 22, 22, 0);
	this->CPacketLengthExMgr::Add(10695, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10694, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10696, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10697, 2, 2, 0);
	this->CPacketLengthExMgr::Add(11015, 22, 22, 0);
	this->CPacketLengthExMgr::Add(11016, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10688, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10689, 26, 26, 0);
	this->CPacketLengthExMgr::Add(10777, 42, 42, 0);
	this->CPacketLengthExMgr::Add(10690, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10700, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10701, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10702, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10703, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10704, 100, 100, 0);
	this->CPacketLengthExMgr::Add(10714, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10715, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10716, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10717, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10727, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10728, 20, 20, 0);
	this->CPacketLengthExMgr::Add(10729, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10730, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10734, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10735, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10736, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10737, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10731, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10738, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10739, 22, 22, 0);
	this->CPacketLengthExMgr::Add(10740, 24, 24, 0);
	this->CPacketLengthExMgr::Add(10741, 8, 8, 0);
	this->CPacketLengthExMgr::Add(10757, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10758, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10759, 20, 20, 0);
	this->CPacketLengthExMgr::Add(10760, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10761, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10762, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10763, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10764, 22, 22, 0);
	this->CPacketLengthExMgr::Add(10765, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10766, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10768, 16, 16, 0);
	this->CPacketLengthExMgr::Add(10769, 22, 22, 0);
	this->CPacketLengthExMgr::Add(10770, 32, 32, 0);
	this->CPacketLengthExMgr::Add(10771, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10772, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10773, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10752, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10753, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10754, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10755, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10756, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10774, -1, 7, 0);
	this->CPacketLengthExMgr::Add(10775, -1, 7, 0);
	this->CPacketLengthExMgr::Add(10778, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10779, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10780, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10781, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10782, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10783, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10784, 62, 62, 0);
	this->CPacketLengthExMgr::Add(10785, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10786, 78, 78, 0);
	this->CPacketLengthExMgr::Add(10787, 42, 42, 0);
	this->CPacketLengthExMgr::Add(10788, 8, 8, 0);
	this->CPacketLengthExMgr::Add(10789, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10790, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10791, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10792, -1, 56, 0);
	this->CPacketLengthExMgr::Add(10793, -1, 36, 0);
	this->CPacketLengthExMgr::Add(10794, 50, 50, 0);
	this->CPacketLengthExMgr::Add(10795, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10796, -1, 6, 0);
	this->CPacketLengthExMgr::Add(10797, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10798, -1, 15, 0);
	this->CPacketLengthExMgr::Add(10799, -1, 7, 0);
	this->CPacketLengthExMgr::Add(10800, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10801, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10804, 11, 11, 0);
	this->CPacketLengthExMgr::Add(10805, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10802, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10803, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10806, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10807, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10808, 15, 15, 0);
	this->CPacketLengthExMgr::Add(10809, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10810, 187, 187, 0);
	this->CPacketLengthExMgr::Add(10811, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10812, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10813, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10814, 2, 2, 0);
	this->CPacketLengthExMgr::Add(11017, 62, 62, 0);
	this->CPacketLengthExMgr::Add(11018, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10815, 18, 18, 0);
	this->CPacketLengthExMgr::Add(11019, 6, 6, 0);
	this->CPacketLengthExMgr::Add(11020, 10, 10, 0);
	this->CPacketLengthExMgr::Add(11021, 6, 6, 0);
	this->CPacketLengthExMgr::Add(11022, 10, 10, 0);
	this->CPacketLengthExMgr::Add(12001, 10, 10, 0);
	this->CPacketLengthExMgr::Add(12002, 14, 14, 0);
	this->CPacketLengthExMgr::Add(12003, 10, 10, 0);
	this->CPacketLengthExMgr::Add(12004, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10816, -1, 61, 0);
	this->CPacketLengthExMgr::Add(10818, -1, 33, 0);
	this->CPacketLengthExMgr::Add(10819, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10820, 40, 40, 0);
	this->CPacketLengthExMgr::Add(10821, -1, 38, 0);
	this->CPacketLengthExMgr::Add(10822, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10823, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10824, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10825, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10826, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10827, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10828, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10829, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10830, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10831, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10832, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10833, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10834, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10835, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10836, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10837, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10838, 35, 35, 0);
	this->CPacketLengthExMgr::Add(10839, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10840, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10841, 54, 54, 0);
	this->CPacketLengthExMgr::Add(10842, 82, 82, 0);
	this->CPacketLengthExMgr::Add(10843, 82, 82, 0);
	this->CPacketLengthExMgr::Add(10844, 59, 59, 0);
	this->CPacketLengthExMgr::Add(10845, 55, 55, 0);
	this->CPacketLengthExMgr::Add(10846, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10847, 58, 58, 0);
	this->CPacketLengthExMgr::Add(10848, 59, 59, 0);
	this->CPacketLengthExMgr::Add(10849, 55, 55, 0);
	this->CPacketLengthExMgr::Add(10850, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10851, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10852, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10853, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10854, 30, 30, 0);
	this->CPacketLengthExMgr::Add(10855, -1, 4, 0);
	this->CPacketLengthExMgr::Add(10870, 102, 102, 0);
	this->CPacketLengthExMgr::Add(10871, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10872, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10873, -1, 77, 0);
	this->CPacketLengthExMgr::Add(10874, -1, 48, 0);
	this->CPacketLengthExMgr::Add(10875, -1, 16, 0);
	this->CPacketLengthExMgr::Add(10876, -1, 14, 0);
	this->CPacketLengthExMgr::Add(10877, -1, 20, 0);
	this->CPacketLengthExMgr::Add(10879, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10880, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10881, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10882, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10883, 34, 34, 0);
	this->CPacketLengthExMgr::Add(10884, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10885, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10886, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10887, -1, 5, 0);
	this->CPacketLengthExMgr::Add(10888, 63, 63, 0);
	this->CPacketLengthExMgr::Add(10889, 59, 59, 0);
	this->CPacketLengthExMgr::Add(10890, 34, 34, 1);
	this->CPacketLengthExMgr::Add(10891, 38, 38, 1);
	this->CPacketLengthExMgr::Add(10892, 14, 14, 1);
	this->CPacketLengthExMgr::Add(10894, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10895, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10896, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10817, 8, 8, 0);
	this->CPacketLengthExMgr::Add(10897, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10898, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10899, -1, 29, 0);
	this->CPacketLengthExMgr::Add(10900, 8, 8, 1);
	this->CPacketLengthExMgr::Add(10901, 8, 8, 1);
	this->CPacketLengthExMgr::Add(10903, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10905, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10904, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10902, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10906, 20, 20, 0);
	this->CPacketLengthExMgr::Add(20101, -1, 12, 0);
	this->CPacketLengthExMgr::Add(20102, -1, 18, 0);
	this->CPacketLengthExMgr::Add(20103, -1, 14, 0);
	this->CPacketLengthExMgr::Add(20104, -1, 22, 0);
	this->CPacketLengthExMgr::Add(20105, -1, 12, 0);
	this->CPacketLengthExMgr::Add(20106, 38, 38, 0);
	this->CPacketLengthExMgr::Add(10924, 18, 18, 1);
	this->CPacketLengthExMgr::Add(10908, 44, 44, 1);
	this->CPacketLengthExMgr::Add(10909, 24, 24, 0);
	this->CPacketLengthExMgr::Add(10910, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10911, 52, 52, 0);
	this->CPacketLengthExMgr::Add(10912, -1, 36, 0);
	this->CPacketLengthExMgr::Add(10913, 125, 125, 0);
	this->CPacketLengthExMgr::Add(10954, 161, 161, 0);
	this->CPacketLengthExMgr::Add(10914, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10915, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10916, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10917, -1, 6, 0);
	this->CPacketLengthExMgr::Add(10918, -1, 12, 0);
	this->CPacketLengthExMgr::Add(10919, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10920, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10921, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10922, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10923, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10925, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10928, 31, 31, 0);
	this->CPacketLengthExMgr::Add(10929, 26, 26, 0);
	this->CPacketLengthExMgr::Add(10930, 7, 7, 0);
	this->CPacketLengthExMgr::Add(10931, 12, 12, 0);
	this->CPacketLengthExMgr::Add(10934, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10935, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10933, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10936, -1, 29, 0);
	this->CPacketLengthExMgr::Add(10937, -1, 31, 0);
	this->CPacketLengthExMgr::Add(10939, -1, 25, 0);
	this->CPacketLengthExMgr::Add(10938, 18, 18, 0);
	this->CPacketLengthExMgr::Add(10941, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10942, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10943, 8, 8, 0);
	this->CPacketLengthExMgr::Add(10944, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10945, 109, 109, 0);
	this->CPacketLengthExMgr::Add(10946, 43, 43, 0);
	this->CPacketLengthExMgr::Add(10947, -1, 31, 0);
	this->CPacketLengthExMgr::Add(10948, 44, 44, 0);
	this->CPacketLengthExMgr::Add(10949, 109, 109, 0);
	this->CPacketLengthExMgr::Add(10955, 97, 97, 0);
	this->CPacketLengthExMgr::Add(10940, -1, 8, 0);
	this->CPacketLengthExMgr::Add(10950, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10951, 10, 10, 0);
	this->CPacketLengthExMgr::Add(10952, 14, 14, 0);
	this->CPacketLengthExMgr::Add(10953, 8, 8, 0);
	this->CPacketLengthExMgr::Add(10956, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10957, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10958, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10959, 6, 6, 0);
	this->CPacketLengthExMgr::Add(10960, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10961, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10962, 2, 2, 0);
	this->CPacketLengthExMgr::Add(10963, 4, 4, 0);
	this->CPacketLengthExMgr::Add(10932, 108, 108, 0);
}
...
void CPacketLengthExMgr::InitPacketLenWithClient()
{
	...
	this->CPacketLengthExMgr::Add(107, -1, 4, 0);
	...
	this->CPacketLengthExMgr::Add(114, 19, 19, 0);
	this->CPacketLengthExMgr::Add(130, 2, 2, 0);
	this->CPacketLengthExMgr::Add(133, 5, 5, 0);
	this->CPacketLengthExMgr::Add(137, 7, 7, 0);
	this->CPacketLengthExMgr::Add(140, -1, 4, 0);
	this->CPacketLengthExMgr::Add(126, 6, 6, 0);
	...
	this->CPacketLengthExMgr::Add(155, 5, 5, 0);
	this->CPacketLengthExMgr::Add(204, 6, 6, 0);
	this->CPacketLengthExMgr::Add(206, 2, 2, 0);
	this->CPacketLengthExMgr::Add(159, 6, 6, 0);
	this->CPacketLengthExMgr::Add(162, 6, 6, 0);
	this->CPacketLengthExMgr::Add(167, 8, 8, 0);
	...
	this->CPacketLengthExMgr::Add(243, 8, 8, 0);
	this->CPacketLengthExMgr::Add(245, 8, 8, 0);
	this->CPacketLengthExMgr::Add(247, 2, 2, 0);
	...
	this->CPacketLengthExMgr::Add(278, 10, 10, 0);
	...
	this->CPacketLengthExMgr::Add(400, 90, 90, 0);
	...
	this->CPacketLengthExMgr::Add(2466, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2467, -1, 8, 0);
	this->CPacketLengthExMgr::Add(2468, 18, 18, 0);
	this->CPacketLengthExMgr::Add(2469, 7, 7, 0);
	this->CPacketLengthExMgr::Add(2475, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2470, 12, 12, 0);
	this->CPacketLengthExMgr::Add(2471, 10, 10, 0);
	this->CPacketLengthExMgr::Add(2472, 16, 16, 0);
	this->CPacketLengthExMgr::Add(2473, 10, 10, 0);
	this->CPacketLengthExMgr::Add(2474, 16, 16, 0);
	this->CPacketLengthExMgr::Add(2476, -1, 8, 0);
	this->CPacketLengthExMgr::Add(2477, 10, 10, 0);
	this->CPacketLengthExMgr::Add(2478, 17, 17, 0);
	this->CPacketLengthExMgr::Add(2479, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2480, 8, 8, 0);
	this->CPacketLengthExMgr::Add(2481, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2482, 8, 8, 0);
	this->CPacketLengthExMgr::Add(2483, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2484, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2485, 2, 2, 0);
	this->CPacketLengthExMgr::Add(2486, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2487, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2488, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2489, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2490, 2, 2, 0);
	this->CPacketLengthExMgr::Add(2491, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2492, 6, 6, 0);
	this->CPacketLengthExMgr::Add(2493, 2, 2, 0);
	this->CPacketLengthExMgr::Add(2494, 2, 2, 0);
	this->CPacketLengthExMgr::Add(2495, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2497, 10, 10, 0);
	this->CPacketLengthExMgr::Add(2498, -1, 4, 0);
	this->CPacketLengthExMgr::Add(2499, 8, 8, 0);
	this->CPacketLengthExMgr::Add(2500, 8, 8, 0);
	this->CPacketLengthExMgr::Add(2501, 1042, 1042, 0);
	this->CPacketLengthExMgr::Add(2502, -1, 16, 0);
	this->CPacketLengthExMgr::Add(2503, 18, 18, 0);
	this->CPacketLengthExMgr::Add(2504, -1, 13, 0);
	this->CPacketLengthExMgr::Add(2505, -1, 4, 0);
	this->CPacketLengthExMgr::Add(2506, -1, 23, 0);
	this->CPacketLengthExMgr::Add(2507, 17, 17, 1);
	this->CPacketLengthExMgr::Add(2508, -1, 4, 0);
	this->CPacketLengthExMgr::Add(2509, 8, 8, 1);
	this->CPacketLengthExMgr::Add(2510, 102, 102, 1);
	this->CPacketLengthExMgr::Add(2511, -1, 4, 0);
	this->CPacketLengthExMgr::Add(2512, -1, 4, 0);
	this->CPacketLengthExMgr::Add(2513, 14, 14, 1);
	this->CPacketLengthExMgr::Add(2514, -1, 28, 0);
	this->CPacketLengthExMgr::Add(2515, -1, 28, 0);
	this->CPacketLengthExMgr::Add(2516, 2, 2, 0);
	this->CPacketLengthExMgr::Add(2517, -1, 4, 1);
	this->CPacketLengthExMgr::Add(2518, -1, 4, 1);
	this->CPacketLengthExMgr::Add(2520, 2, 2, 1);
	this->CPacketLengthExMgr::Add(2519, -1, 4, 1);
	this->CPacketLengthExMgr::Add(2521, 4, 4, 0);
	this->CPacketLengthExMgr::Add(2522, 6, 6, 0);
}
