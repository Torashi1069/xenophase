...
#include "Enum.h" // MAPPROPERTY_SIEGE
...
hook_func<int (CCharacter::*)(int property)> CCharacter__IsItPossible(EXEPATH(), "CCharacter::IsItPossible");
int CCharacter::IsItPossible(int property)
{
	return (this->*CCharacter__IsItPossible)(property);
...
void CCharacter::MultiCast(char* buf, int len)
{
	//TODO
/*
	m_neighborCache.CNeighborCache::OnMultiCast(len, buf, 18);
*/
}
