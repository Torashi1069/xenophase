...
class CHSvrIOPacketHandler : public CPacketHandler
{
	...
	public: HOOKED void CHSvrIOPacketHandler::OnLogonPermit(CPC* const in_pPlayer, const unsigned long in_AID, const unsigned long in_GID, const char* in_IDstr, const unsigned long in_TotalUsingTime, const int in_selectedCharNum, CLogonPermitADBWork* const in_cpADBWork);
