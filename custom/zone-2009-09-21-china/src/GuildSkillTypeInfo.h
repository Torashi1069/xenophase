...
class SK_GD_EXTENSION : public CSkillTypeInfo
{
	...
	public: HOOKED virtual int SK_GD_EXTENSION::OnMsg(CCharacter* sender, unsigned short receiver, int MsgID, int skLevel, int targetID, int par3, MSGpar::CVar par4);
