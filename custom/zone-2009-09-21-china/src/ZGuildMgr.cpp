...
#include "Custom/umage.hpp" //MIN_GUILDS
#include "shared.h" // Trace()


/// @patch dynamic guild cache memmgr - r2559
HOOKED CZGuildMgr::CZGuildMgr(void) // line 10
{
	m_MaxGuildCounter = 0;
}
...
/// @patch dynamic guild cache memmgr - r2559
HOOKED CZGuildMgr::~CZGuildMgr(void) // line 15
{
}
...
HOOKED void CZGuildMgr::MakeGuild(unsigned long GDID, GUILDINFO* Info) // line 95
{
...
/// @patch dynamic guild cache memmgr - r2559 r2561
hook_method<void (CZGuildMgr::*)(void)> CZGuildMgr::_Init(SERVER, "?Init@CZGuildMgr@@UAEXXZ");
HOOKED void CZGuildMgr::Init(void) // line 21
{
//	return (this->*_Init)();

	m_zGuildMPool.CMemoryMgr<CZGuildInfo>::Init(DYNAMIC);
}


/// @patch dynamic guild cache memmgr - r2559 r2561
hook_method<void (CZGuildMgr::*)(int Max_Guild)> CZGuildMgr::_Init2(SERVER, "?Init@CZGuildMgr@@QAEXH@Z");
HOOKED void CZGuildMgr::Init(int Max_Guild) // line 25
{
...
HOOKED CGuild* CZGuildMgr::AllocGuild(void) // line 45
{
...
VHOOKED void CZGuildMgr::FreeGuild(CGuild* guild, int disorganize) // line 49
{
...
/// @patch dynamic guild cache memmgr - r2560
hook_method<unsigned long (CZGuildMgr::*)(void)> CZGuildMgr::_GetOffset(SERVER, "CZGuildMgr::GetOffset");
HOOKED unsigned long CZGuildMgr::GetOffset(void) // line 170
{
	return 0;
