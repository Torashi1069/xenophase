...
public:
	...
	public: HOOKED int CPC::isNotifyPosition(short xPos, short yPos);
	...
	public: HOOKED short CPC::GetItemDef(int isServer, int isClient);
	...
	public: HOOKED void CPC::Send(int len, char* buf);
	//public: bool CPC::Send2(const unsigned char*, const int);
	public: HOOKED void CPC::ForceSend(int len, char* buf);
	...
	public: HOOKED void CPC::CancelMCStore(void);
	...
	public: HOOKED void CPC::OnMakeCouple(unsigned long gid);
	...
	public: HOOKED void CPC::SetEffectByGospel(CCharacter* ch);
	...
	public: HOOKED int CPC::IsCrazyKiller(void);
	...
	public: HOOKED int CPC::UpdatePKInfo(CPC* winner, CPC* loser);
	public: HOOKED void CPC::SetPKInfo(int win, int lose, char* kill_name, char* killed_name, int bLoserCrazyKiller);
	public: HOOKED void CPC::SetKillerSystem(void);
	public: HOOKED void CPC::NotifyPKInfo(void);
	...
	private: HOOKED int CPC::GetAttackFinalDamage(CCharacter* other, int position, int skillProperty, int plusATTPowerPercent, int plusATTSuccessPercent, int type, int isRangeAttack, unsigned short SKID, short skLevel);
	...
	private: HOOKED void CPC::OnDead(unsigned long enemyAID, int& isRestart);
	...
	public: void CPC::SetItem(int itid, int value);
	public: int CPC::GetItem(int itid);
