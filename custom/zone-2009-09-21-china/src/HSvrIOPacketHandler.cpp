...
HOOKED void CHSvrIOPacketHandler::OnLogonPermit(CPC* const in_pPlayer, const unsigned long in_AID, const unsigned long in_GID, const char* in_IDstr, const unsigned long in_TotalUsingTime, const int in_selectedCharNum, CLogonPermitADBWork* const in_cpADBWork) // line 575
{
//	return (this->*_OnLogonPermit2)(in_pPlayer, in_AID, in_GID, in_IDstr, in_TotalUsingTime, in_selectedCharNum, in_cpADBWork);
	...
	PACKET_ZC_AID aidpacket;
	aidpacket.PacketType = HEADER_ZC_AID;
	aidpacket.AID = in_AID;
	in_pPlayer->CPC::ForceSend(sizeof(aidpacket), (char *)&aidpacket);
#else
