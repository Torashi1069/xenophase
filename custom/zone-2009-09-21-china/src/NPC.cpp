...
CNPC::CNPC(void) // line 69
{
	...
	m_mapRes = NULL;
	m_nBanTime = 0;
	m_eatingItemMPool.CMemoryMgr<EATING_ITEM_INVENTORY>::Init(DYNAMIC);
}


/// @patch dynamic mob loot memmgr - r2569
HOOKED CNPC* CNPC::CNPCCtorHookHelper(void)
{
	(this->*_CNPC)();
	m_eatingItemMPool.CMemoryMgr<EATING_ITEM_INVENTORY>::Init(DYNAMIC);
	return this;
...
/// @patch dynamic mob loot memmgr - r2569
HOOKED void CNPC::CNPCDtorHookHelper(void)
{
	m_eatingItemMPool.CMemoryMgr<EATING_ITEM_INVENTORY>::Init(0);
	(this->*__CNPC)();
}
