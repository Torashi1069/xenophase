...
class CZGuildMgr : public CGuildMgr
{
	...
	public: HOOKED CZGuildMgr::CZGuildMgr(void);
	public: HOOKED virtual CZGuildMgr::~CZGuildMgr(void);
	...
	public: HOOKED void CZGuildMgr::MakeGuild(unsigned long GDID, GUILDINFO* Info);
	public: HOOKED virtual void CZGuildMgr::Init(void);
	public: HOOKED void CZGuildMgr::Init(int Max_Guild);
	public: HOOKED virtual CGuild* CZGuildMgr::AllocGuild(void);
	public: VHOOKED virtual void CZGuildMgr::FreeGuild(CGuild* guild, int disorganize);
	...
	public: HOOKED unsigned long CZGuildMgr::GetOffset(void);
