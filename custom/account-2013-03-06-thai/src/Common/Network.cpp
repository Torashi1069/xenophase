#include "Account.h" // g_scrptConfig
...
DWORD CNetwork::GetLocalIP(bool mode)
{
	...
	DWORD dwPublicIP = inet_addr(g_scrptConfig.CInfoScript::GetInfo("PUBLIC_IP"));
	DWORD dwPrivateIP = inet_addr(g_scrptConfig.CInfoScript::GetInfo("PRIVATE_IP"));
