...
struct PACKET_CZ_MONSTER_TALK
{
	...
	{
		TPacket<PACKET_CZ_MONSTER_TALK> in(p);
		TPacket<PROTO_CZ_MONSTER_TALK> out;
	...
	{
		TPacket<PROTO_CZ_MONSTER_TALK> in(p);
		TPacket<PACKET_CZ_MONSTER_TALK> out;
