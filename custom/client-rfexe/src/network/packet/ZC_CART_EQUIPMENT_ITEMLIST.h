struct PROTO_ZC_CART_EQUIPMENT_ITEMLIST
{
	short PacketType;
	short PacketLength;
	struct ITEM
...
struct PACKET_ZC_CART_EQUIPMENT_ITEMLIST
{
	...
	{
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST,PACKET_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> in(p);
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> out(in.count());
	...
	{
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> in(p);
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST,PACKET_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> out(in.count());
...
struct PACKET_ZC_CART_EQUIPMENT_ITEMLIST2
{
	...
	static Packet* ToProto(short PacketType, Packet* p)
	{
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST2,PACKET_ZC_CART_EQUIPMENT_ITEMLIST2::ITEM> in(p);
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> out(in.count());
	...
	{
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> in(p);
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST2,PACKET_ZC_CART_EQUIPMENT_ITEMLIST2::ITEM> out(in.count());
...
struct PACKET_ZC_CART_EQUIPMENT_ITEMLIST3
{
	...
	static Packet* ToProto(short PacketType, Packet* p)
	{
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST3,PACKET_ZC_CART_EQUIPMENT_ITEMLIST3::ITEM> in(p);
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> out(in.count());
	...
	{
		TPacket<PROTO_ZC_CART_EQUIPMENT_ITEMLIST,PROTO_ZC_CART_EQUIPMENT_ITEMLIST::ITEM> in(p);
		TPacket<PACKET_ZC_CART_EQUIPMENT_ITEMLIST3,PACKET_ZC_CART_EQUIPMENT_ITEMLIST3::ITEM> out(in.count());
