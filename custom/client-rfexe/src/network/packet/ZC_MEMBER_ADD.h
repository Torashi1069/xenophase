...
struct PACKET_ZC_MEMBER_ADD
{
	...
	{
		TPacket<PACKET_ZC_MEMBER_ADD> in(p);
		TPacket<PROTO_ZC_MEMBER_ADD> out;
	...
	{
		TPacket<PROTO_ZC_MEMBER_ADD> in(p);
		TPacket<PACKET_ZC_MEMBER_ADD> out;
