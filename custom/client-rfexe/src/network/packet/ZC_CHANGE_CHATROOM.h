struct PROTO_ZC_CHANGE_CHATROOM
{
	short PacketType;
	short PacketLength;
	unsigned long AID;
...
struct PACKET_ZC_CHANGE_CHATROOM
{
	...
	{
		TPacket<PACKET_ZC_CHANGE_CHATROOM,char> in(p);
		TPacket<PROTO_ZC_CHANGE_CHATROOM,char> out(in.count());
	...
	{
		TPacket<PROTO_ZC_CHANGE_CHATROOM,char> in(p);
		TPacket<PACKET_ZC_CHANGE_CHATROOM,char> out(in.count());
