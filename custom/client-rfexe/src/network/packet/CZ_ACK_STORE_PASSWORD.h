struct PROTO_CZ_ACK_STORE_PASSWORD
{
	short PacketType;
	short Type;
...
struct PACKET_CZ_ACK_STORE_PASSWORD
{
	...
	{
		TPacket<PACKET_CZ_ACK_STORE_PASSWORD> in(p);
		TPacket<PROTO_CZ_ACK_STORE_PASSWORD> out;
	...
	{
		TPacket<PROTO_CZ_ACK_STORE_PASSWORD> in(p);
		TPacket<PACKET_CZ_ACK_STORE_PASSWORD> out;
