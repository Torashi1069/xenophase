...
static ProtocolImpl ProtocolInstance("Client 2010-06-22a RagexeRE Korea");
void ProtocolImpl::InitInstance()
{
	...
	REGV(107, 27, HEADER_HC_ACCEPT_ENTER, PROTOID_HC_ACCEPT_ENTER, PACKET_HC_ACCEPT_ENTER_KRO20100413);
	REGN(108, 3, HEADER_HC_REFUSE_ENTER, PROTOID_HC_REFUSE_ENTER, PACKET_HC_REFUSE_ENTER);
	REGN(109, 114, HEADER_HC_ACCEPT_MAKECHAR, PROTOID_HC_ACCEPT_MAKECHAR, PACKET_HC_ACCEPT_MAKECHAR_KRO20061023);
...
//	REGN(114, 22, HEADER_CZ_USE_SKILL, TODO, TODO); // nonstandard
//	REGN(0x7FFE, 4, HEADER_ZC_AID_RAW, PROTOID_ZC_AID, PACKET_ZC_AID_RAW);
	...
	REGN(126, 105, HEADER_CZ_USE_SKILL_TOGROUND_WITHTALKBOX, PROTOID_CZ_USE_SKILL_TOGROUND_WITHTALKBOX, PACKET_CZ_USE_SKILL_TOGROUND_WITHTALKBOX__PAD8_2_2_3); // nonstandard
...
//	REGN(130, 2, HEADER_CZ_REQUEST_QUIT, PROTOID_CZ_REQUEST_QUIT, PACKET_CZ_REQUEST_QUIT);
	...
	REGN(133, 10, HEADER_CZ_CHANGE_DIRECTION, PROTOID_CZ_CHANGE_DIRECTION, PACKET_CZ_CHANGE_DIRECTION__PAD2_3); // nonstandard
	...
	REGN(137, 11, HEADER_CZ_REQUEST_TIME, PROTOID_CZ_REQUEST_TIME, PACKET_CZ_REQUEST_TIME__PAD5); // nonstandard
	...
	REGN(140, 14, HEADER_CZ_REQNAME, PROTOID_CZ_REQNAME, PACKET_CZ_REQNAME__PAD8); // nonstandard
...
//	REGN(143, 6, HEADER_SC_ENTRY_ACK, PROTOID_SC_ENTRY_ACK, PACKET_SC_ENTRY_ACK); // no-len
	...
	REGN(148, 19, HEADER_CZ_MOVE_ITEM_FROM_BODY_TO_STORE, PROTOID_CZ_MOVE_ITEM_FROM_BODY_TO_STORE, PACKET_CZ_MOVE_ITEM_FROM_BODY_TO_STORE__PAD1_10); // nonstandard
...
//	REGN(155, 34, HEADER_CZ_ENTER, PROTOID_CZ_ENTER, PACKET_CZ_ENTER__TODO); // nonstandard
...
//	REGN(159, 20, HEADER_CZ_USE_ITEM, PROTOID_CZ_USE_ITEM, PACKET_CZ_USE_ITEM__TODO); // nonstandard
	...
	REGN(162, 14, HEADER_CZ_REQNAME_BYGID, PROTOID_CZ_REQNAME_BYGID, PACKET_CZ_REQNAME_BYGID__PAD8); // nonstandard
	...
	REGN(167, 9, HEADER_CZ_REQUEST_MOVE, PROTOID_CZ_REQUEST_MOVE, PACKET_CZ_REQUEST_MOVE__PAD4); // nonstandard
...
//	REGN(233, 19, HEADER_ZC_ADD_EXCHANGE_ITEM, PROTOID_ZC_ADD_EXCHANGE_ITEM, PACKET_ZC_ADD_EXCHANGE_ITEM);
	...
	REGN(245, 11, HEADER_CZ_ITEM_PICKUP, PROTOID_CZ_ITEM_PICKUP, PACKET_CZ_ITEM_PICKUP__PAD5); // nonstandard
	REGN(246, 8, HEADER_ZC_DELETE_ITEM_FROM_STORE, PROTOID_ZC_DELETE_ITEM_FROM_STORE, PACKET_ZC_DELETE_ITEM_FROM_STORE);
	REGN(247, 17, HEADER_CZ_MOVE_ITEM_FROM_STORE_TO_BODY, PROTOID_CZ_MOVE_ITEM_FROM_STORE_TO_BODY, PACKET_CZ_MOVE_ITEM_FROM_STORE_TO_BODY__PAD1_8); // nonstandard
...
//	REGN(255, 10, HEADER_CZ_JOIN_GROUP, PROTOID_CZ_JOIN_GROUP, PACKET_CZ_JOIN_GROUP);
	...
	REGN(275, 25, HEADER_CZ_USE_SKILL_TOGROUND, PROTOID_CZ_USE_SKILL_TOGROUND, PACKET_CZ_USE_SKILL_TOGROUND__PAD8_2_2_3); // nonstandard
	...
	REGN(278, 17, HEADER_CZ_ITEM_THROW, PROTOID_CZ_ITEM_THROW, PACKET_CZ_ITEM_THROW__PAD4_7); // nonstandard
...
//	REGN(400, 23, HEADER_CZ_REQUEST_ACT, PROTOID_CZ_REQUEST_ACT, PACKET_CZ_REQUEST_ACT__TODO); // nonstandard
...
//	REGN(524, 19, HEADER_CZ_EXE_HASHCHECK, PROTOID_CZ_EXE_HASHCHECK, PACKET_CZ_EXE_HASHCHECK); // no-len
	...
	REGN(527, 10, HEADER_CZ_REQ_PVPPOINT, PROTOID_CZ_REQ_PVPPOINT, PACKET_CZ_REQ_PVPPOINT);
	REGN(528, 22, HEADER_ZC_ACK_PVPPOINT, PROTOID_ZC_ACK_PVPPOINT, PACKET_ZC_ACK_PVPPOINT);
//	REGN(529, 6, HEADER_ZH_MOVE_PVPWORLD); // server-only // no-len
...
//	REGN(639, 8, HEADER_CA_CLIENT_TYPE, PROTOID_CA_CLIENT_TYPE, PACKET_CA_CLIENT_TYPE);
	...
	REGV(647, 12, HEADER_ZC_PC_CASH_POINT_ITEMLIST, PROTOID_ZC_PC_CASH_POINT_ITEMLIST, PACKET_ZC_PC_CASH_POINT_ITEMLIST__KRO2010);
	REGN(648, 10, HEADER_CZ_PC_BUY_CASH_POINT_ITEM, PROTOID_CZ_PC_BUY_CASH_POINT_ITEM, PACKET_CZ_PC_BUY_CASH_POINT_ITEM__KRO2010);
	REGN(649, 12, HEADER_ZC_PC_CASH_POINT_UPDATE, PROTOID_ZC_PC_CASH_POINT_UPDATE, PACKET_ZC_PC_CASH_POINT_UPDATE__KRO2010);
...
//	REGV(678, -1, HEADER_ZC_HACKSH_CPX_MSG); // no-len
//	REGV(679, -1, HEADER_CZ_HACKSH_CPX_MSG); // no-len
...
//	REGN(687, ?, HEADER_CZ_SRPACKET_START); // no-len
	REGN(688, 85, HEADER_CA_LOGIN_CHANNEL);
...
//	REGN(707, ?, UNUSED_HEADER_CZ_FORMATSTRING_MSG_RES); // no-len
	...
	REGN(738, 20, HEADER_CZ_USE_ITEM_NEW_JAPEN);
	REGN(739, 22, HEADER_CZ_USE_SKILL_NEW_JAPEN);
	REGN(740, 11, HEADER_CZ_ITEM_PICKUP_NEW_JAPEN);
	REGN(741, 9, HEADER_CZ_REQUEST_MOVE_NEW_JAPEN);
...
//	REGN(1093, 10, HEADER_CZ_SIMPLE_BUY_CASH_POINT_ITEM); // nonstandard
...
//	REGN(2017, 15, HEADER_ZC_SKILLINFO_UPDATE2, PROTOID_ZC_SKILLINFO_UPDATE, PACKET_ZC_SKILLINFO_UPDATE2); //FIXME: temporarily incompatible
	...
	REGN(2021, 8, HEADER_CH_ENTER_CHECKBOT);
	...
	REGN(2033, 15, HEADER_ZC_ACK_BATTLE_STATE_MONITOR);
	REGN(2034, 6, HEADER_ZC_BATTLE_NOTI_START_STEP);
	REGN(2035, 4, HEADER_ZC_BATTLE_JOIN_NOTI_DEFER);
	...
	REGN(2106, 4, HEADER_ZC_OPEN_SEARCH_STORE_INFO);
