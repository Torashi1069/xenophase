...
int __cdecl main(int argc, const char** argv, const char** envp)
{
	...
	if( gLocalServerInfo.m_dwIP != CSingleton<CNetwork>::getSingletonPtr()->CNetwork::GetLocalIP(true) )
		CSingleton<CReporter>::getSingletonPtr()->CReporter::FatalError("PUBLIC_IP misconfigured, check character.config.txt and ServerInfo table");
	if( gLocalServerInfo.m_dwPrivateIP != CSingleton<CNetwork>::getSingletonPtr()->CNetwork::GetLocalIP(false) )
		CSingleton<CReporter>::getSingletonPtr()->CReporter::FatalError("PRIVATE_IP misconfigured, check character.config.txt and ServerInfo table");
	...
	#define CONF(X) ( g_characterConfig.CInfoScript::GetInfo(X) != NULL ) ? atoi(g_characterConfig.CInfoScript::GetInfo(X))
	/////////////////////////////////////////////////////////////////////////////
	...
	const int ZONE_PROCESS_OBJ_NUM = CONF("ZONE_PROCESS_OBJ_NUM") : 20;
