...
class CPacketHandler
{
	...
	public: virtual void CPacketHandler::SetLastError(unsigned long lastError);
...
private:
	...
	static hook_method<void (CPacketHandler::*)(unsigned long lastError)> CPacketHandler::_SetLastError;
