...
enum
{
	HEADER_NZ_NEWNPC            = 10000,
	HEADER_ZN_ACKNEWNPC         = 10001,
	HEADER_ZN_CONTACT           = 10002,
	HEADER_NZ_MAPMOVE_ACK       = 10003,
	HEADER_NZ_MENU_ACK          = 10004,
	HEADER_NZ_ITEMLIST          = 10005,
	HEADER_NZ_WARPNPC_COMMAND   = 10006,
	HEADER_NZ_GUIDENPC_COMMAND  = 10007,
	HEADER_NZ_TRADERNPC_COMMAND = 10008,
	HEADER_ZN_ANSWER            = 10009,
	HEADER_NZ_CHANGE_MONEY      = 10010,
	HEADER_NZ_CHANGE_ITEM       = 10011,
	HEADER_NZ_CHANGE_VAR        = 10012,
	HEADER_NZ_CHANGE_STATE      = 10013,
	HEADER_NZ_SET_ITEM          = 10014,
	HEADER_NZ_WAIT_DIALOG       = 10015,
	HEADER_NZ_CLOSE_DIALOG      = 10016,
	HEADER_NZ_DIALOG_ACK        = 10017,
	HEADER_NZ_HEAL              = 10018,
	HEADER_NZ_EXCHANGE_ITEM     = 10019,
	HEADER_NZ_CHECKPOINT        = 10020,
	HEADER_NZ_NOTIFY_STOREDITEM = 10021,
	HEADER_NZ_CARTON            = 10022,
	HEADER_NZ_DLG_WRITE         = 10023,
	HEADER_NZ_TRADER            = 10024,
	HEADER_NZ_COMPASS           = 10025,
	HEADER_NZ_NUDE              = 10026,
	HEADER_NZ_SHOW_IMAGE        = 10027,
	HEADER_NZ_CHANGEPALLETE     = 10028,
	HEADER_NZ_ADDSKILL          = 10029,
};
...
{// 10009 (0x2719)
	...
	/* this+ 6 */ unsigned long CAID;
	/* this+10 */ unsigned char answerType;
	/* this+11 */ long answer;
};
...
{// 10017 (0x2721)
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long NAID;
	/* this+6 */ unsigned short length;
	/* this+8 */ unsigned long CAID;
};
...
{// 10019 (0x2723)
	...
	/* this+ 2 */ unsigned long NAID;
	/* this+ 6 */ unsigned long CAID;
	/* this+10 */ unsigned short getItemITID;
	/* this+12 */ short getItemcount;
	/* this+14 */ unsigned short dropItemITID;
	/* this+16 */ short dropItemcount;
};
...
{// 10586 (0x295A)
	...
	/* this+ 4 */ unsigned long GDID;
	/* this+ 8 */ unsigned long AID;
	/* this+12 */ GUILDMPOSITION Info[];
};


struct PACKET_IZ_GUILD_NOTICE_TOD
{// 10587 (0x295B)
	//TODO (1010b+)
};
...
struct PACKET_IZ_GUILD_LEVEL_UP
{// 10607 (0x296F)
	//TODO (18b)
};
...
{// 10608 (0x2970)
	/* this+  0 */ short PacketType;
	/* this+  2 */ GUILDMINFO MInfo;
	/* this+142 */ unsigned long FragNum;
	/* this+146 */ unsigned long GDID;
};


struct PACKET_IZ_GET_GUILD_EMBLEM_IMG_FRAG
{// 10609 (0x2971)
	//TODO (16b)
};


struct PACKET_ZI_REGISTER_GUILD_EMBLEM_IMG_FRAG
{// 10610 (0x2972)
	//TODO (16b)
};
...
{// 10615 (0x2977)
	...
	/* this+30 */ unsigned char type;
	/* this+31 */ int zeny;
	/* this+35 */ unsigned char ret; // enumZENYUPDATERESULT
};


struct PACKET_ZI_GUILD_ZENY_UPDATE_ALL
{// 10616 (0x2978)
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long GDID;
...
{// 10662 (0x29A6)
	...
	/* this+ 97 */ char FromName[24];
	/* this+121 */ unsigned long DeleteTime;
	/* this+125 */ char Text[];
};
...
{// 10666 (0x29AA)
	...
	/* this+ 2 */ unsigned long AID;
	/* this+ 6 */ int MailID;
	/* this+10 */ char ItemInfo[40];
	/* this+50 */ char ItemLen;
	/* this+51 */ unsigned long Money;
	/* this+55 */ char FromName[24];
};
...
{// 10669 (0x29AD)
	/* this+ 0 */ short PacketType;
	/* this+ 2 */ unsigned long AID;
	/* this+ 6 */ unsigned long MailID;
	/* this+10 */ char Header[40];
	/* this+50 */ char FromName[24];
};
...
{// 10672 (0x29B0)
	/* this+0 */ short PacketType;
	/* this+2 */ long InterProcessTime;
	/* this+6 */ long ZoneProcessTime;
};
...
{// 10675 (0x29B3)
	...
	/* this+ 6 */ unsigned long AID;
	/* this+10 */ unsigned long GID;
	/* this+14 */ char FromName[24];
	/* this+38 */ unsigned long ReceiveAID;
	/* this+42 */ unsigned long ReceiveGID;
};
...
{// 10676 (0x29B4)
	...
	/* this+ 6 */ unsigned long AID;
	/* this+10 */ unsigned long GID;
	/* this+14 */ short Result;
	/* this+16 */ char ItemInfo[40];
	/* this+56 */ char ItemLen;
	/* this+57 */ unsigned long Money;
	/* this+61 */ char FromName[24];
};
...
{// 10698 (0x29CA)
	...
	/* this+14 */ char MemorialDungeonName[61];
};
...
struct PACKET_ZI_REQ_MAKE_GUILD_SSO
{// 10784 (0x2A20)
	//TODO (62b)
};


struct PACKET_ZI_REQ_BAN_GUILD_SSO
{// 10785 (0x2A21)
	//TODO (58b)
};


struct PACKET_IZ_ACK_BAN_GUILD_SSO
{// 10786 (0x2A22)
	//TODO (78b)
};
...
{// 10816 (0x2A40)
	...
	/* this+ 4 */ unsigned long AID;
	/* this+ 8 */ unsigned long GID;
	/* this+12 */ int isPCBang;
	/* this+16 */ int PayType;
	/* this+20 */ int ConnectionArea;
	/* this+24 */ int ConnectionState;
	/* this+28 */ int EventNum;
	/* this+32 */ unsigned long ConnectionTime;
	/* this+36 */ short PremiumType;
	/* this+38 */ short PremiumType2;
	/* this+40 */ int SpareType4;
	/* this+44 */ int MaxStoreCnt;
	enum { FLAGMASK_WORLDENTRANCE = 1, FLAGMASK_FORCENOTIFY = 2 };
	/* this+48 */ unsigned char flag;
	/* this+49 */ int Exp;
	/* this+53 */ int Death;
	/* this+57 */ int Drop;
};
...
struct PACKET_IZ_GET_GUILD_EMBLEM_IMG2
{// 10931 (0x2AB3)
	//TODO (12b)
};
