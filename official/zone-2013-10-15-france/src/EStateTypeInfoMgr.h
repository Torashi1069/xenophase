...
class ESTATE_SCRIPT_SCANNER : public CInterpretHandler
{
public:
	ESTATE_SCRIPT_SCANNER();
	bool Scan(CBinBuf* binBuf);
...
private:
	bool FuncBuff(const char* EStateName);

private:
	/* this+ 0 */ //CInterpretHandler baseclass_0;
	/* this+ 8 */ bool m_isError;
	/* this+12 */ CInterpreter m_interpreter;
	/* this+76 */ ESTATE_SCRIPT* m_EStateScript;
};
