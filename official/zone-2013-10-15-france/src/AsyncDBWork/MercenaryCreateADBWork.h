...
class CMercenaryCreateADBWork : public NAsyncDBWork
{
public:
	enum enumResult
	{
		...
		RESULT_ERROR_MERCENARY_CREATE = 2,
	};
...
private:
	...
	/* this+32 */ const int m_Job;
	/* this+36 */ const int m_RemainLifeSECOND;
...
public:
	CMercenaryCreateADBWork(const unsigned long in_AID, const unsigned long in_GID, const int in_Job, const int in_RemainLifeSECOND);
	virtual ~CMercenaryCreateADBWork();
};
