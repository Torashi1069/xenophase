  ...
  m_ProcessFuncPtr(&CInstantMapCtrl::ProcCreate)
{
	...
	m_ProcessFuncPtr = &CInstantMapCtrl::ProcCreate;
	N3MessageMgr::GetObj()->N3MessageMgr::Post(this->N3Object::GetMyID(), N3MSGID(CInstantMapCtrl,MSG_REQUEST_MAPLOADING2), 0, 0);
	m_bOK = true;
}
...
void CInstantMapCtrl::ProcOperation(const int in_Message, const int in_wParam, const int in_lParam)
{
	switch( in_Message )
	{
	case N3MSGID(CInstantMapCtrl,MSG_NONE2):
	{
		Sleep(0);
	}
	break;
	case N3MSGID(CInstantMapCtrl,MSG_REQUEST_DESTROY2):
	{
		...
		N3MessageMgr::GetObj()->N3MessageMgr::Post(this->N3Object::GetMyID(), N3MSGID(CInstantMapCtrl,MSG_NONE2), 0, 0);
	}
	break;
	default:
	{
