...
public:
	...
	unsigned int Put(std::string in_Data);
...
private:
	...
	public:
		/* this+ 0 */ //const N3DataTransferMgr::lcData::`vftable';
		/* this+ 4 */ std::vector<unsigned char> m_data;
		/* this+28 */ unsigned long m_Time;
	};

	typedef std::map<unsigned int,lcData> DATAMAP;
