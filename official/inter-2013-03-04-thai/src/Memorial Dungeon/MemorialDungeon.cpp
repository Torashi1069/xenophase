  ...
  m_ProcessFuncPtr(&CMemorialDungeon::Process_PROCSTEP_CREATE_INSTANTMAP)
{
	...
	N3MessageMgr::GetObj()->N3MessageMgr::Post(this->N3Object::GetMyID(), N3MSGID(CMemorialDungeon,MSG_INSTANTMAP_CREATE2), 0, 0);
	m_bOK = true;
}
...
void CMemorialDungeon::Process_PROCSTEP_OPERATION(const int in_Message, const int in_wParam, const int in_lParam)
{
	switch( in_Message )
	{
	case N3MSGID(CMemorialDungeon,MSG_NONE2):
	{
		Sleep(0);
	}
	break;
	case N3MSGID(CMemorialDungeon,MSG_DYING_WISH_REQUEST2):
	{
		m_State = STATE_ERROR;
		m_ProcessFuncPtr = &CMemorialDungeon::Process_PROCSTEP_DYING_WISH;
		N3MessageMgr::GetObj()->N3MessageMgr::Post(this->N3Object::GetMyID(), N3MSGID(CMemorialDungeon,MSG_INSTANTMAP_DESTROY2), 0, 0);
	}
	break;
	default:
	{
...
void CMemorialDungeon::Process_PROCSTEP_CREATE_INSTANTMAP(const int in_Message, const int in_wParam, const int in_lParam)
{
	...
	break;
	case N3MSGID(CMemorialDungeon,MSG_INSTANTMAP_CREATE2):
	{
	...
	break;
	case N3MSGID(CInstantMap,MSG_CREATE_SUCCESS2):
	{
	...
	break;
	case N3MSGID(CInstantMap,MSG_CREATE_ERROR2):
	case N3MSGID(CInstantMap,MSG_ERROR_FOUND2):
	{
		m_State = STATE_ERROR;
		CMemorialDungeonMgr::GetObj()->CMemorialDungeonMgr::CreateResult(m_hParty, false);
		m_ProcessFuncPtr = &CMemorialDungeon::Process_PROCSTEP_DYING_WISH;
...
void CMemorialDungeon::Process_PROCSTEP_DYING_WISH(const int in_Message, const int in_wParam, const int in_lParam)
{
	...
	break;
	case N3MSGID(CMemorialDungeon,MSG_INSTANTMAP_DESTROY2):
	{
