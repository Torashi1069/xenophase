...
class hook_ptr<struct mystd::_Tree<int,struct mystd::pair<int const ,struct PathNode *>,struct mystd::map<int,struct PathNode *,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Kfn,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Node *> mystd::_Tree<int,struct mystd::pair<int const ,struct PathNode *>,struct mystd::map<int,struct PathNode *,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Kfn,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Nil(SAKEXE, "?_Nil@?$_Tree@HU?$pair@$$CBHPAUPathNode@@@std@@U_Kfn@?$map@HPAUPathNode@@U?$less@H@std@@V?$allocator@PAUPathNode@@@3@@2@U?$less@H@2@V?$allocator@PAUPathNode@@@2@@std@@1PAU_Node@12@A");
class hook_val<unsigned int> mystd::_Tree<int,struct mystd::pair<int const ,struct PathNode *>,struct mystd::map<int,struct PathNode *,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Kfn,struct mystd::less<int>,class mystd::allocator<struct PathNode *> >::_Nilrefs(SAKEXE, "?_Nilrefs@?$_Tree@HU?$pair@$$CBHPAUPathNode@@@std@@U_Kfn@?$map@HPAUPathNode@@U?$less@H@std@@V?$allocator@PAUPathNode@@@3@@2@U?$less@H@2@V?$allocator@PAUPathNode@@@2@@std@@1IA");
