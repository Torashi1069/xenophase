...
// ripped off of http://www.codeproject.com/KB/security/aes.aspx
#define CRijndael CAES
...
public:
	...
	void MakeKey(char const* key=sm_key, char const* chain=sm_iv, int keylength=DEFAULT_BLOCK_SIZE, int blockSize=DEFAULT_BLOCK_SIZE);
...
private:
	static const char sm_key[16]; /// @Gravity
	static const char sm_iv[16]; /// @Gravity
