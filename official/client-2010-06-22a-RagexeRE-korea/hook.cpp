...
void SymDBInitCallback()
{
	...
	SymDB::Add("InitLanguage", 0x52B190);
	...
	SymDB::Add("g_extended_slot", 0x80ED8C);
	...
	SymDB::Add("g_regstrationWeb", 0x76BAA4);
	...
	SymDB::Add("NameBalloonfontSize", 0x76BAC0);
	SymDB::Add("NameBalloonShorten", 0x80ED8F);
	SymDB::Add("NameBalloonfontBold", 0x80ED90);
	SymDB::Add("szCharNameEcryption", 0x7938C0);
	SymDB::Add("stateId", 0x7D6018);
	SymDB::Add("s_dwAdminAID", 0x80E618);
	SymDB::Add("s_dwYellowAID", 0x80E600);
	...
	SymDB::Add("title_random", 0x80E628);
