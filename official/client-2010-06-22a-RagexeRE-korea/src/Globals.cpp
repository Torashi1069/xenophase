...
BOOL& g_sysQuit = VTOR<int>(SymDB::Find("g_sysQuit"));
...
bool& g_hideAccountList = VTOR<bool>(SymDB::Find("g_hideAccountList")); // = ?;
...
bool& g_extended_slot = VTOR<bool>(SymDB::Find("g_extended_slot")); // = ?;
...
const char*& g_licence = VTOR<const char*>(SymDB::Find("g_licence")); // = "";
const char*& g_regstrationWeb = VTOR<const char*>(SymDB::Find("g_regstrationWeb")); // = "";
char& title_random = VTOR<char>(SymDB::Find("title_random")); // = ?;
int& NameBalloonfontSize = VTOR<int>(SymDB::Find("NameBalloonfontSize")); // = 12;
bool& NameBalloonShorten = VTOR<bool>(SymDB::Find("NameBalloonShorten")); // = ?;
bool& NameBalloonfontBold = VTOR<bool>(SymDB::Find("NameBalloonfontBold")); // = ?;
mystd::vector<DWORD>& s_dwAdminAID = VTOR<mystd::vector<DWORD>>(SymDB::Find("s_dwAdminAID")); // = ?
mystd::vector<DWORD>& s_dwYellowAID = VTOR<mystd::vector<DWORD>>(SymDB::Find("s_dwYellowAID")); // = ?
