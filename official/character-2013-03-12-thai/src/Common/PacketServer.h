...
enum
{
	...
	HEADER_IZ_PARTY_RECRUIT_CANCEL_VOLUNTEER          = 10878, //FIXME: duplicate
...
{// 10677
	...
	/* this+46 */ short PremiumType;
	/* this+48 */ short PremiumType2;
...
struct PACKET_HA_REQ_PLAYING_LIMITINFO
{// 10680
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long AID;
};
...
{// 10688
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long AID;
	/* this+6 */ int TimeMinute;
};


struct PACKET_AH_NOTIFY_PCBANG_PLAYING_TIME
{// 10690
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long AID;
	/* this+6 */ int TimeMinute;
...
struct PACKET_AH_LOGON_ACK_EXTEND_BILLING_INFO : public PACKET_AH_LOGON_ACK
{// 10704
	/* this+  0 */ //PACKET_AH_LOGON_ACK baseclass_0;
	/* this+ 98 */ WORD wRateType;
	/* this+100 */ DWORD dwPERSONGRADE;
};


struct PACKET_ZH_PLAYER_ALIVE
{// 10714
	/* this+0 */ short PacketType;
	/* this+2 */ unsigned long AID;
	/* this+6 */ unsigned long GID;
...
struct PACKET_AH_DISPATCH_PREMIUM_INFO
{// 10726
	/* this+ 0 */ short PacketType;
	/* this+ 2 */ unsigned short reason;
	/* this+ 4 */ unsigned long AID;
	/* this+ 8 */ unsigned long GID;
	/* this+12 */ unsigned long dwPERSONGRADE;
	/* this+16 */ unsigned short wPCBangGrade;
	/* this+18 */ unsigned short wPadding;
};
...
{//	10908
	...
	/* this+ 2 */ bool bAuth;
	/* this+ 3 */ char ID[24];
	/* this+27 */ unsigned long AID;
	/* this+31 */ unsigned long GID;
	/* this+35 */ unsigned long TotalUsingTime;
	/* this+39 */ int selectedCharNum;
	/* this+43 */ bool bWorldEnterance;
};
...
{// 10937
	...
	/* this+23 */ int Death;
	/* this+27 */ int Drop;
	/* this+31 */ //PACKET_ZC_PERSONAL_INFOMATION::DETAIL_EXP_INFO pcInfo;
	/* this+38 */ //PACKET_ZC_PERSONAL_INFOMATION::DETAIL_EXP_INFO prmInfo;
};
