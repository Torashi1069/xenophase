...
void CPCBattle::ModifyDamage_ATK(CCharacter* other, int& damage, int isRNGATK, int isSKATK, int isCRI)
{
	return (this->*_ModifyDamage_ATK)(other, damage, isRNGATK, isSKATK, isCRI);
